...
public sealed class PostCommentTreeNode
{
    ...
    internal async Task TryLoadReactions(IMoaServices services)
    {
        ...
        var reactionData = await services.ComputeServices.PostServices.TryGetCommentReactionData(services.ClientServices.ActiveAccountServices.ActiveSession, PostId, Id);
