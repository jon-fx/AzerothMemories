...
{
    public static async Task<bool> TryHandle(ILogger<PostServices> logger, CommonServices commonServices, Post_TryReportPostTags command, CancellationToken cancellationToken)
    {
