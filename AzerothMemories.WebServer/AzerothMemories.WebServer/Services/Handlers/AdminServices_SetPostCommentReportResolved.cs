...
{
    public static async Task<bool> TryHandle(ILogger<AdminServices> services, CommonServices commonServices, Admin_SetPostCommentReportResolved command, CancellationToken cancellationToken)
    {
