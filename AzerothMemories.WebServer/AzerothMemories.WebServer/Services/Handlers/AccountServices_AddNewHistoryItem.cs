...
{
    public static async Task<bool> TryHandle(ILogger<AccountServices> services, CommonServices commonServices, Account_AddNewHistoryItem command, CancellationToken cancellationToken)
    {
