...
{
    public static async Task TryHandle(ILogger<AccountServices> services, CommonServices commonServices, Auth_SignOut command, CancellationToken cancellationToken)
    {
