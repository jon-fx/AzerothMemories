...
{
    public static async Task TryHandle(ILogger<AccountServices> services, CommonServices commonServices, AuthBackend_SetupSession command, CancellationToken cancellationToken)
    {
