...
{
    public static async Task TryHandle(ILogger<AccountServices> logger, CommonServices commonServices, AuthBackend_SetupSession command, CancellationToken cancellationToken)
    {
