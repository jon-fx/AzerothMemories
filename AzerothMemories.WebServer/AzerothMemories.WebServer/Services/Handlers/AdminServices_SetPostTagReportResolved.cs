...
{
    public static async Task<bool> TryHandle(ILogger<AdminServices> logger, CommonServices commonServices, Admin_SetPostTagReportResolved command, CancellationToken cancellationToken)
    {
