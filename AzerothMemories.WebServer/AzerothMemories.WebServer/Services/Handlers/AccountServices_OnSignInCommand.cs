...
{
    public static async Task TryHandle(ILogger<AccountServices> logger, CommonServices commonServices, IDbSessionInfoRepo<AppDbContext, DbSessionInfo<string>, string> sessionRepo, AuthBackend_SignIn command, CancellationToken cancellationToken)
    {
