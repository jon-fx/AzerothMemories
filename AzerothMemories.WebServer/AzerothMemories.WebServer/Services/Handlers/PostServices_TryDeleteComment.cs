...
{
    public static async Task<long> TryHandle(ILogger<PostServices> logger, CommonServices commonServices, Post_TryDeleteComment command, CancellationToken cancellationToken)
    {
