...
{
    public static async Task<AccountFollowingStatus?> TryHandle(ILogger<FollowingServices> services, CommonServices commonServices, Following_TryStopFollowing command, CancellationToken cancellationToken)
    {
