...
{
    public static async Task<AccountFollowingStatus?> TryHandle(ILogger<FollowingServices> logger, CommonServices commonServices, Following_TryStopFollowing command, CancellationToken cancellationToken)
    {
