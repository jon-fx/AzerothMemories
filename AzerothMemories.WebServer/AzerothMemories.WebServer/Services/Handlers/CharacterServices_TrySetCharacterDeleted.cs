...
{
    public static async Task<bool> TryHandle(ILogger<CharacterServices> services, CommonServices commonServices, Character_TrySetCharacterDeleted command, CancellationToken cancellationToken)
    {
