...
{
    public static async Task<bool> TryHandle(ILogger<AccountServices> logger, CommonServices commonServices, Account_TryChangeUsername command, CancellationToken cancellationToken)
    {
