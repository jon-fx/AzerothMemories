...
{
    public static async Task<bool> TryHandle(ILogger<AccountServices> logger, CommonServices commonServices, Account_TryUpdateAuthToken command, CancellationToken cancellationToken)
    {
