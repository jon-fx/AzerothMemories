...
{
    public static async Task<bool> TryHandle(ILogger<AccountServices> services, CommonServices commonServices, Account_TryUpdateAuthToken command, CancellationToken cancellationToken)
    {
