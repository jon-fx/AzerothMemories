...
{
    public static async Task<int> TryHandle(ILogger<PostServices> logger, CommonServices commonServices, Post_TryReactToPost command, CancellationToken cancellationToken)
    {
