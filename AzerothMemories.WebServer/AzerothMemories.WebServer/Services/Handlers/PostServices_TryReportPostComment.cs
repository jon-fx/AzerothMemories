...
{
    public static async Task<bool> TryHandle(ILogger<PostServices> services, CommonServices commonServices, Post_TryReportPostComment command, CancellationToken cancellationToken)
    {
